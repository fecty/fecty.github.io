...
var ASM_CONSTS = {
  ...
  26366: () => Module.canvas.width,
  26398: () => parseInt(Module.canvas.style.width),
  26446: () => {
    document.exitFullscreen();
  },
  26473: () => {
  ...
  26809: () => window.innerWidth,
  26835: () => window.innerHeight,
  26862: () => {
    if (document.fullscreenElement) return 1;
  },
  26908: () => Module.canvas.width,
  26940: () => parseInt(Module.canvas.style.width),
  26988: () => {
    if (document.fullscreenElement) return 1;
  },
  27034: () => Module.canvas.width,
  27066: () => screen.width,
  27091: () => window.innerWidth,
  27117: () => window.innerHeight,
  27144: () => {
    if (document.fullscreenElement) return 1;
  },
  27190: () => Module.canvas.width,
  27222: () => screen.width,
  27247: () => {
    document.exitFullscreen();
  },
  ...
  27320: () => Module.canvas.width,
  27352: () => parseInt(Module.canvas.style.width),
  27400: () => {
    document.exitFullscreen();
  },
  27427: ($0) => {
  ...
  27465: () => screen.width,
  27490: () => screen.height,
  27516: () => window.screenX,
  27543: () => window.screenY,
  27570: () => window.devicePixelRatio,
  27606: ($0) => {
  ...
  28147: () => window.innerWidth,
  28173: () => window.innerHeight,
};
...
function assignWasmExports(wasmExports) {
  ...
  _free = Module["_free"] = wasmExports["pe"];
  _malloc = Module["_malloc"] = wasmExports["qe"];
  ...
  dynCall_ii = dynCalls["ii"] = wasmExports["ue"];
  dynCall_vii = dynCalls["vii"] = wasmExports["ve"];
  dynCall_viii = dynCalls["viii"] = wasmExports["we"];
  dynCall_viff = dynCalls["viff"] = wasmExports["xe"];
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["ye"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["ze"];
  dynCall_vidd = dynCalls["vidd"] = wasmExports["Ae"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["Be"];
  dynCall_vi = dynCalls["vi"] = wasmExports["Ce"];
  dynCall_vffff = dynCalls["vffff"] = wasmExports["De"];
  dynCall_vf = dynCalls["vf"] = wasmExports["Ee"];
  dynCall_viiiiiiii = dynCalls["viiiiiiii"] = wasmExports["Fe"];
  dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["Ge"];
  dynCall_i = dynCalls["i"] = wasmExports["He"];
  dynCall_vff = dynCalls["vff"] = wasmExports["Ie"];
  dynCall_v = dynCalls["v"] = wasmExports["Je"];
  dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["Ke"];
  dynCall_iii = dynCalls["iii"] = wasmExports["Le"];
  dynCall_vfi = dynCalls["vfi"] = wasmExports["Me"];
  dynCall_viif = dynCalls["viif"] = wasmExports["Ne"];
  dynCall_vif = dynCalls["vif"] = wasmExports["Oe"];
  dynCall_vifff = dynCalls["vifff"] = wasmExports["Pe"];
  dynCall_viffff = dynCalls["viffff"] = wasmExports["Qe"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["Re"];
  dynCall_vfff = dynCalls["vfff"] = wasmExports["Se"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["Te"];
  dynCall_iidiiii = dynCalls["iidiiii"] = wasmExports["Ue"];
  _asyncify_start_unwind = wasmExports["Ve"];
  _asyncify_stop_unwind = wasmExports["We"];
  _asyncify_start_rewind = wasmExports["Xe"];
  _asyncify_stop_rewind = wasmExports["Ye"];
...
var wasmImports = {
  ...
  Na: __abort_js,
  Xa: _clock_time_get,
  A: _emscripten_asm_const_double,
  h: _emscripten_asm_const_int,
  Va: _emscripten_date_now,
  ke: _emscripten_get_element_css_size,
  ...
  $d: _emscripten_glGetQueryObjectuivEXT,
  ...
  Za: _emscripten_glPolygonModeWEBGL,
  ...
  _: _emscripten_set_resize_callback_on_thread,
